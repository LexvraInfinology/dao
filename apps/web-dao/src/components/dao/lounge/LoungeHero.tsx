...
export const LoungeHero: React.FC = () => {
  return (
    <div className="relative rounded-3xl overflow-hidden bg-white border border-[#E2ECF9] shadow-[0_4px_25px_rgba(15,23,42,0.03)]">
      ...
      <div className="hidden lg:flex items-center justify-between p-6 lg:p-7 xl:p-10 relative z-10 min-h-[200px] gap-4">
        ...
        {/* Right Composition: Micro-tags + 3D Holographic Jewel with Orbital Rings */}
        <div className="flex items-center gap-4 xl:gap-8 shrink-0">
          {/* Micro-tags Stacks */}
          <div className="text-right space-y-3 xl:space-y-4 select-none">
            <div className="space-y-0.5">
              <div className="text-[9px] xl:text-[10px] font-bold font-jakarta text-[#155EEF] uppercase tracking-wider">
                100 PEOPLE
              </div>
              <div className="text-[9px] xl:text-[10px] font-bold font-jakarta text-[#155EEF] uppercase tracking-wider">
                1 PROTOCOL
            ...
            <div className="space-y-0.5 pt-1">
              <div className="text-[9px] xl:text-[10px] font-bold font-jakarta text-[#64748B] uppercase tracking-wider">
                GOVERNANCE
              </div>
              <div className="text-[9px] xl:text-[10px] font-bold font-jakarta text-[#64748B] uppercase tracking-wider">
                INCOME
          ...
          {/* 3D Ethereum Jewel with Orbital Rings */}
          <div className="relative w-32 h-32 lg:w-36 lg:h-36 xl:w-48 xl:h-48 flex items-center justify-center shrink-0">
            ...
            <div className="absolute w-16 h-16 lg:w-20 lg:h-20 xl:w-24 xl:h-24 rounded-full border border-blue-400/20 rotate-75 pointer-events-none" />

            {/* Floating 3D Ethereum Jewel */}
      ...
      <div className="lg:hidden flex items-center justify-between p-5 sm:p-6 gap-4 relative z-10">
        ...
        <div className="space-y-1.5 flex-1 min-w-0">
          ...
          <h1 className="text-xl sm:text-2xl font-black font-jakarta text-[#071A4A] tracking-tight">
            Your Command Center
          </h1>
